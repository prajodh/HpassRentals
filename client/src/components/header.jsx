...
import backgroud from "../../assets/intro3.jpg"

export const Header = (props) => {
  return (
    <header id="header" className="w-full bg-no-repeat bg-center bg-cover" style={{ backgroundImage: "url(../../assets/intro3.jpg)", backgroundColor: '#000000' }}>
